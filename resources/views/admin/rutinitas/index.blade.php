    ...
    <div class="container-fluid">
        <table class="table table-striped table-bordered">
            ...
            @foreach($rutinitas as $val)
                <tr class="d-flex">
                    ...
                    <td class="col-2">
                        <a href="{{ url('/rutinitas/'.$val->id.'/edit') }}" class="btn btn-primary">Edit</a>
                        <form action="{{ url('/rutinitas/'.$val->id) }}" method="POST">
                            @method('DELETE')
                            @csrf
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm">{{ $rutinitas->links() }}</div>
                <div class="col-sm"></div>
            </div>
        </div>
    </div>
