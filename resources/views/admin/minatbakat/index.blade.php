    ...
    <div class="container-fluid">
        <table class="table table-striped table-bordered">
            ...
            @foreach($minatbakat as $val)
                <tr class="d-flex">
                    ...
                    <td class="col-2">
                        <a href="{{ url('/minatbakat/'.$val->id.'/edit') }}" class="btn btn-primary">Edit</a>
                        <form action="{{ url('/minatbakat/'.$val->id) }}" method="POST">
                            @method('DELETE')
                            @csrf
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm">{{ $minatbakat->links() }}</div>
                <div class="col-sm"></div>
            </div>
        </div>
    </div>
