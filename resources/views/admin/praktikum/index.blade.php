...
@section('content')
    <div>
        ...
        @if($deskripsi != null)
            ...
            <a href="{{ url('/praktikumRoute/edit/'.$deskripsi->id) }}" class="btn btn-success">Ubah Deskripsi</a>
        @else
            <a href="{{ url('/praktikumRoute/deskripsicreate') }}" class="btn btn-success">Tambah Deskripsi</a>
        @endif
    </div>
