    ...
    <div class="container-fluid">
        <table class="table table-striped table-bordered">
            ...
            @php
                $i = 1;
            @endphp
            @foreach($ekstrakurikuler as $val)
                <tr class="d-flex">
                    ...
                    <td class="col-2">
                        <a href="{{ url('/ekstrakurikuler/'.$val->id.'/edit') }}" class="btn btn-primary">Edit</a>
                        <form action="{{ url('/ekstrakurikuler/'.$val->id) }}" method="POST">
                            @method('DELETE')
                            @csrf
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm">{{ $ekstrakurikuler->links() }}</div>
                <div class="col-sm"></div>
            </div>
        </div>
    </div>
